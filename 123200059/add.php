  ...
  <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavDropdown" aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="Toggle navigation">
    ...
    <table class="table table-borderless" id="table">
      <tr>
        ...
        <td><input type="text" name="item_id" id="item_id" class="col-sm-7" placeholder="Item Code" aria-label="Item Code example" required></td>
        </div>
      </tr>
      <tr>
        <div class="form-group" style="padding-bottom: 10px;">
        <td><label for="item_name" class="col-sm-5 col-form-label">Name of goods</label></td>
      ...
      <tr>
        ...
        <td><input type="number" name="amount" id="amount" placeholder="Amount" aria-label="Amount example" required></td>
        </div>
      </tr>
      <tr>
        <div class="form-group" style="padding-bottom: 10px;">
      ...
      <tr>
        ...
        <td><select class="form-select" aria-label="Category select example" name="category">
      ...
      <td><label for="item_status" class="col-sm-5 col-form-label">Status</label></td>
          ...
          <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" name="item_status" id="inlineRadio3" value="Damaged">
    ...
    <tr>
        <div class="form-group" style="padding-bottom: 10px;">
        <td> </td>
        <td><center><button type="submit" name="submit" class="btn btn-success">Save</button>
